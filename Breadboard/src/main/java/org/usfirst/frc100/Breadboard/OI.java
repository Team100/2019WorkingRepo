...
public class OI {
    ...
    public OI() {
        ...
        pickupButton = new JoystickButton(leftStick, 1);
        ...
        pivotHalfButton.whenPressed(new SmartTurn(180));
        ...
        SmartDashboard.putData("Pivot 90 ->", new SmartTurn(90));
        SmartDashboard.putData("Pivot 180 ->", new SmartTurn(180));
