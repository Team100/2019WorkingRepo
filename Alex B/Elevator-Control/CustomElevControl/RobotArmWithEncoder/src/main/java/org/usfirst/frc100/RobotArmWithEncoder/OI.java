...
import org.usfirst.frc100.RobotArmWithEncoder.subsystems.*;
...
public class OI {
    ...
    public JoystickButton teleop;
    public Joystick teleopJoystick;
    ...
    public OI() {
        ...
        teleop = new JoystickButton(teleopJoystick,3);
        home.whileHeld(new RobotArmHome());


        // SmartDashboard Buttons
        SmartDashboard.putData("Autonomous Command", new AutonomousCommand());
        SmartDashboard.putData("RobotArmHome", new RobotArmHome());
    ...
    public Joystick getTeleopJoystick() {
        return teleopJoystick;
    }
