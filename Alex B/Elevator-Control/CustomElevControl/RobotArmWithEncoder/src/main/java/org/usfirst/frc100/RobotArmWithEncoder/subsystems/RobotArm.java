...
public class RobotArm extends PIDSubsystem {
    ...
    private Encoder robotArmEncoder;
    private VictorSP robotArmMotor;
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PID
        state = States.INIT;
        homeState = HomeStates.NOT_STARTED;

        // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        robotArmEncoder = new Encoder(2, 3, false);
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=DEFAULT_COMMAND
        ...
        setDefaultCommand(new TeleopArmDrive());
    }
