...
parser.add_argument("--reverse", help="Reverse camera product IDs", action="store_true")
...
for camera in device_info:
	if device_info[camera]["model_id"] == ("0810" if args.reverse else "0779"):
	...
	elif device_info[camera]["model_id"] == ("0779" if args.reverse else "0810"):
