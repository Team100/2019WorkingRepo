...
public class Robot extends TimedRobot {
    ...
    // Timestamped encoder and gyro values
    // Format: timestamp -> [gyro, right master encoder, left master encoder]
    //public static Map<Long, Double[]> previousEncoderGyro = new ConcurrentHashMap<Long, Double[]>();
